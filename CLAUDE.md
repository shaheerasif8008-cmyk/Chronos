...
```
DO NOT: Build impressive UI before the runtime is real.
DO NOT: Skip the seams and call connectors/memory directly.
DO NOT: Use synchronous Python anywhere in the API layer.
DO NOT: Add any table without organization_id and region columns.
DO NOT: Log credentials, even for debugging.
DO NOT: Allow direct writes to audit_log from application code — only INSERT via audit.log().
DO NOT: Start Sprint 2 before Sprint 1 exit criteria all pass.
DO NOT: Onboard client 2 before Phase 3 multi-tenant infrastructure is live.
```
