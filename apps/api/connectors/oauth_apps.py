...
APPS: dict[str, OAuthApp] = {
    ...
    "canva": OAuthApp(
        id="canva",
        name="Canva",
        description="Create presentations and designs, autofill brand templates, and export to PPTX/PDF.",
        icon_svg='<svg viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" fill="#00C4CC"/><path d="M15 9.5c-.6-1-1.6-1.6-2.8-1.6-2 0-3.4 1.8-3.4 4.1 0 2.3 1.4 4.1 3.4 4.1 1.2 0 2.2-.6 2.8-1.6" stroke="#fff" stroke-width="1.6" stroke-linecap="round"/></svg>',
        ...
        policy="Creating designs and exports happens in the connected Canva account; all actions run through the broker and are audited.",
    ),
    "hubspot": OAuthApp(
        id="hubspot",
        name="HubSpot",
